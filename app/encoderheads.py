...
class FullyConnectedEncoderHead(torch.nn.Module):
    def _init_(self, input_dim, embed_dim=128):
        super(FullyConnectedEncoderHead, self)._init_()
...
class FullyConnectedBatchNormEncoderHead(torch.nn.Module):
    def _init_(self, input_dim, embed_dim=128):
        super(FullyConnectedBatchNormEncoderHead, self)._init_()
...
class FullyConnectedDropoutEncoderHead(torch.nn.Module):
    def _init_(self, input_dim, embed_dim=128):
        super(FullyConnectedDropoutEncoderHead, self)._init_()
...
class BiLSTMEncoderHead(torch.nn.Module):
    def _init_(self, input_dim, embed_dim=128):
        super(BiLSTMEncoderHead, self)._init_()
...
class IdentityEncoderHead(torch.nn.Module):
    def _init_(self, input_dim, embed_dim=128):
        super(IdentityEncoderHead, self)._init_()
